    ...
    <section class="content">
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
			...
			<div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" placeholder="Enter description..." id="eventDescription"></textarea>
                </div>
              <div class="form-group">
                <label>Date:</label>
        ...
        <div class="box-footer">
          <button type="submit" class="btn btn-info pull-right" id="insertEvent">Submit</button>
        </div>
      </div>
      <!-- /.box -->
	  <div class="box box-default">
        ...
        <div class="box-body">
			...
			<div class="row">
                ...
                <thead>
                <tr role="row">
				<th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="" >Event</th>
				<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="" >Description</th>
				<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="" >Attraction</th>
				<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="" >Date</th>
				<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="" >Actions</th></tr>
                </thead>
                <tbody>
				<?php
					$conn = new DbManager();
					$eventList = $conn->getEvents();
					foreach($eventList as $a){
						echo "<tr role='row'>
								<td class='sorting_1'>$a->nome</td>
								<td>$a->descrizione</td>
								<td>$a->attrazione</td>
								<td>$a->data</td>
								<td><a href='modifyEvent.php?id=$a->id'>modifica</a>   <i class='fa fa-fw fa-close delete' value='$a->id' name='evento'></i></td>
							</tr>";
					}
				  ?>
                </tbody>
