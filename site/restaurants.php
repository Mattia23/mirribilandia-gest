...
<head>
  ...
  <title>Mirribilandia - Restaurants</title>
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
			...
			<!-- text input -->
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter name..." id="restaurantName">
              </div>
              <!-- phone mask -->
              <div class="form-group">
                <label>Phone:</label>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="restaurantPhone" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
			...
			<div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" placeholder="Enter description..." id="restaurantDescription"></textarea>
                </div>
              <div class="form-group">
                  <label for="exampleInputFile">Image</label>
                  <input type="file" accept="image/png" id="restaurantInputFile">
          ...
          <div class="box-footer">
            <button type="submit" class="btn btn-info pull-right" id="insertRestaurant">Submit</button>
          </div>
        </div>
        <!-- /.box-body -->
      ...
      <div class="box box-default">
        ...
        <div class="row">
          ...
          <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                  <thead>
                  <tr role="row">
          <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="" >Restaurant</th>
          ...
          <?php
            $conn = new DbManager();
            $hList = $conn->getRistoranti();
            foreach($hList as $a){
              echo "<tr role='row'>
                  <td class='sorting_1'>$a->nome</td>
                  <td>$a->descrizione</td>
                  <td>$a->tel</td>
                  <td><a href='modifyRestaurant.php?id=$a->id'>modifica</a>   <i class='fa fa-fw fa-close delete' value='$a->id' name='ristorante'></i></td>
                </tr>";
            }
            ?>
                  </tbody>
