...
if(!isset($_GET["id"])){
	...
	$conn = new DbManager();
	$h = $conn->getRestaurantById($_GET["id"]);
}
?>
<!DOCTYPE html>
<html>
  ...
  <div class="content-wrapper" id="mirribilandiaContent">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Restaurants</li>
		<li class="active">Modify restaurant</li>
      </ol>
    </section>
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
			...
			<!-- text input -->
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter name..." id="restaurantName" value="<?php echo $h->nome ?>">
              </div>
              <!-- phone mask -->
              <div class="form-group">
                <label>Phone:</label>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="restaurantPhone" data-inputmask='"mask": "(999) 999-9999"' data-mask value="<?php echo $h->tel ?>">
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
			...
			<div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" placeholder="Enter description..." id="restaurantDescription"><?php echo $h->descrizione ?></textarea>
                </div>
              <div class="form-group">
		  ...
		  <div class="box-footer">
              <button type="submit" class="btn btn-info pull-right" id="updateRestaurant">Submit</button>
            </div>
        </div>
      <!-- /.box -->
