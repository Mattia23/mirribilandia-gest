...
<head>
  ...
  <title>Mirribilandia - Photos</title>
    ...
    <section class="content">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Add new photos</h3>
        ...
        <div class="box-body">
          <div class="row">
			...
			<div class="form-group">
                <label>User</label>
                <select class="form-control select2" style="width: 100%;" id="photoUser">
                  <?php
					$conn = new DbManager();
					$attractionList = $conn->getUsers();
					$first = true;
					foreach($attractionList as $a){
						$optionid=$a->id;
						$optionname=$a->nome;
						$optionname2=$a->cognome;
						if($first){
							$first = false;
							echo "<option value='$optionid' selected='selected'>$optionid - $optionname $optionname2</option>";
						} else	echo "<option value='$optionid'>$optionid - $optionname $optionname2</option>";
					}
				  ?>
                </select>
              </div>
			...
			<div class="form-group">
                ...
                <select class="form-control select2" style="width: 100%;" id="photoAttraction">
                  <?php
					$conn = new DbManager();
			  ...
			  <div class="form-group">
                  ...
                  <input type="file" accept="image/png" id="photoInputFile">
        ...
        <div class="box-footer">
          <button type="submit" class="btn btn-info pull-right" id="insertPhoto">Submit</button>
        </div>
      </div>
      <!-- /.box -->
      <div class="box box-default">
        ...
        <div class="row">
          ...
          <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                  <thead>
                  <tr role="row">
          <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="" >User</th>
          <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="" >Attrazione</th>
          <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="" >Data</th>
          <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="" >Link</th>
          <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="" >Actions</th></tr>
                  </thead>
                  <tbody>
          <?php
            $conn = new DbManager();
              $fList = $conn->getAllFoto();
              foreach($fList as $f){
                echo "<tr role='row'>
                    <td class='sorting_1'>$f->utente</td>
                    <td>$f->attrazione</td>
                    <td>$f->data</td>
                    <td><a href='$f->immagine'>View</a></td>
                    <td><i class='fa fa-fw fa-close delete' value='$f->id' name='foto'></i></td>
                  </tr>";
              }
            ?>
                  </tbody>
